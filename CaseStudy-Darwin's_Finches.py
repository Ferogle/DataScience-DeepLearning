# observing the evolution of beak length and beak depth of finches' 
...
'''The differences are much clearer in the ECDF. The 
mean is larger in the 2012 data, and the variance does appear larger as well.'''
...
'''We get a p-value of 0.0034, which suggests that there is a statistically significant difference. But remember: 
it is very important to know how different they are! In the previous exercise,
...
_ = plt.scatter(bl_1975, bd_1975, marker='.',
             linestyle='None', alpha='0.2', color='blue')

# Make scatter plot of 2012 data
_ = plt.scatter(bl_2012, bd_2012, marker='.',
             linestyle='None', alpha='0.2', color='red')
